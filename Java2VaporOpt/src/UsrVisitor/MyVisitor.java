...
public class MyVisitor extends DepthFirstRetVisitor<String>{
	...
	public ArrayList<String> extendClass = new ArrayList<String>();
	...
	public String visit(final Goal n) {
		...
		for(String i : extendClass)
		{
			SymbolTable.getClassList().get(i).setExtend();
		}
	...
	public String visit(final ClassExtendsDeclaration n) {
	    ...
	    extendClass.add(extendsName);
	    extendClass.add(className);
